...
public class ManageStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabAddNewStudent = findViewById(R.id.fabAddNewStudent);
        ...
        manageStudentAdapter = new ManageStudentAdapter(ManageStudentActivity.this);
        rvManageStudentList.setAdapter(manageStudentAdapter);

        fabAddNewStudent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), AddNewStudentActivity.class);
                startActivityForResult(i, 101);
            }
        });

        manageStudentAdapter.setEventlistener(new ManageStudentAdapter.Eventlistener() {
            @Override
            ...
            public void onItemEditClick(int position, ImageView imgMore) {
                Student data = manageStudentAdapter.getItem(position);
                ...
                popupStudentList.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.edit) {
                            ...
                            Utils.removeStudentData(getActivity(), data);
...
//        }
        ...
        manageStudentAdapter.addAll(Utils.getStudentData(getActivity()));
        refreshPlaceHolder();
//        initDrawer();
        initBack(true);
    }
        ...
        result = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (position == 1) {
                            if (ManageStudentActivity.this instanceof ManageStudentActivity) {
                                hideMenu(true);
                            } else {
...
//        fillProfileData();
    ...
    public ManageStudentActivity getActivity() {
        return this;
    }
...
//            if (b)
    ...
    private void finishActivity() {
        if ((getActivity() instanceof ManageStudentActivity)) {
