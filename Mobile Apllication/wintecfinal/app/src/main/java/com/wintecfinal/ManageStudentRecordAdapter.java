...
public class ManageStudentRecordAdapter extends RecyclerView.Adapter<ManageStudentRecordAdapter.MyViewHolder> {

    public List<StudentRecordModule> studentData = new ArrayList<>();
    Eventlistener mEventlistener;
    Context context;

    public ManageStudentRecordAdapter(Context c) {
        this.context = c;
    }

    public void addAll(List<StudentRecordModule> mData) {
        studentData.clear();
        studentData.addAll(mData);
        notifyDataSetChanged();
    }

    public StudentRecordModule getItem(int position) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.manage_student_record_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        final StudentRecordModule student = studentData.get(position);
